...
print(np.arange(0,11,2)) # returns evenly spaced values from 0-10 with intervals of 2 (0,2,4,6,8,10)
print(np.zeros(5)) #returns array of 3 0s
print(np.zeros((5,3))) #2D array
print(np.ones(4))
print(np.linspace(0,10,3)) #array of 3 evenly spaced nums 0-10 (0,5,10)
